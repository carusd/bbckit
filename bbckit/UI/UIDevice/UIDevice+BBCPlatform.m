//
//  UIDevice+bbc_platform.m
//  ZhuangBility
//
//  Created by lerosua on 2017/1/12.
...
@implementation UIDevice (BBCPlatform)

+ (NSString *) bbc_platform{
    size_t size;
...
+ (NSString *) bbc_platformString{
    NSString *platform = [self bbc_platform];
    ...
    if ([platform isEqualToString:@"iPad6,8"])   return @"iPad Pro 12.9(Wi-Fi+LTE)";
